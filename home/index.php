			...
			<div class="col-auto text-center">
				<div id="sample-cars" class="carousel slide mx-3" data-ride="carousel">
					<ol class="carousel-indicators">
						<li data-target="#sample-cars" data-slide-to="0" class="active"></li>
						<li data-target="#sample-cars" data-slide-to="1"></li>
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="<?= ROOT . '/res/gran-torino.jpg' ?>" class="mb-5 img-fluid rounded shadow-lg logo">
						</div>
						...
						<div class="carousel-item">
							<img src="<?= ROOT . '/res/saetta-mcqueen.png' ?>" class="mb-5 img-fluid rounded logo">
						</div>
						<div class="carousel-item">
